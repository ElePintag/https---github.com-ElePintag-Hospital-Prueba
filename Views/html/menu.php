  ...
  <div>
    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
      <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="Hospitales/hospitales.php" target="base" aria-expanded="false">
            <span>
              <i class="ti ti-article"></i>
            </span>
            <span class="hide-menu">Hospitales</span>
          </a>
        </li>
        <li class="sidebar-item">
          <a class="sidebar-link" href="Doctores/doctores.php" target="base" aria-expanded="false">
            <span>
